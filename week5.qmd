...
Rresult: only one image in Landsat8 can reach the standard,
and the image id is LANDSAT/LC08/C02/T1_L2/LC08_120038_20211004, which means path 120, row 38

![path and row](image/path.png)
...
![visualization by true color (432)](image/vis_map.png)
...
![mosaic picture](image/mosaic.png)
...
![city boundary clip image](image/city_boundary.png)
...
![texture adjustment](image/texture.png)

![pixel distribution under glcm image](image/inspector.png)
...
![example of PCA analysis](image/pcajs.png)
...
![Percentage variables of PCA](image/percentage.png)
...
![2 components](image/pca12.png)

![3 components](image/pca123.png)
...
![NDVI](image/NDVI1.png)

## Reflection

In this week, I learned knowledge in several aspects:
* how to use Google Earth Engine to create points and analyse the ROI assisted with GADM boundary map.
